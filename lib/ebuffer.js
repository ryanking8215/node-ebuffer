...
EBuffer.prototype.writeInt16 = function(v) {
	...
	var byte_order = this._order;
	if (is_le(byte_order)) {
        this._buf.writeInt16LE(v, this._w);
	} else {
		this._buf.writeInt16BE(v, this._w);
	}
	this._w+=size;
}
...
EBuffer.prototype.writeUInt16 = function(v) {
    ...
    var byte_order = this._order;
	if (is_le(byte_order)) {
		this._buf.writeUInt16LE(v, this._w);
	} else {
		this._buf.writeUInt16BE(v, this._w);
	}
	this._w+=size;
}
...
EBuffer.prototype.writeInt32 = function(v) {
	...
	var nbytes = 0;
	if (is_le(byte_order)) {
        this._buf.writeInt32LE(v, this._w);
	} else {
		this._buf.writeInt32BE(v, this._w);
	}
	this._w+=size;
}
...
EBuffer.prototype.writeUInt32 = function(v) {
	...
	var byte_order = this._order;
	if (is_le(byte_order)) {
		this._buf.writeUInt32LE(v, this._w);
	} else {
		this._buf.writeUInt32BE(v, this._w);
	}
	this._w+=size;
}
...
EBuffer.prototype.writeDouble = function(v) {
	...
	var byte_order = this._order;
	if (is_le(byte_order)) {
		this._buf.writeDoubleLE(v, this._w);
	}
	else {
		this._buf.writeDoubleBE(v, this._w);
	}
	this._w+=size;
}
...
EBuffer.prototype.writeFloat = function(v) {
	...
	var byte_order = this._order;
	if (is_le(byte_order)) {
		this._buf.writeFloatLE(v, this._w);
	}
	else {
		this._buf.writeFloatBE(v, this._w);
	}
	this._w+=size;
}
